...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Categoria cat01 = new Categoria(null, "Brinco");
        Categoria cat02 = new Categoria(null, "Colar");
        Categoria cat03 = new Categoria(null, "Pulseira");
        Categoria cat04 = new Categoria(null, "Anel");
        Categoria cat05 = new Categoria(null, "Pingente");

        categoriaRepository.saveAll(Arrays.asList(cat01, cat02, cat03, cat04,cat05));
